...
const Modal = ({ isOpen, close, refetch }) => {
  ...
  return (
    ...
    >
      {/* Overlay */}
      <div className="fixed inset-0 bg-gradient-to-br from-cyan-100/80 via-white/80 to-green-100/80 backdrop-blur-sm" aria-hidden="true" />
        ...
        <div className="flex min-h-full items-center justify-center p-4">
          ...
          >
            ...
            <div className="flex flex-col items-center mb-6">
              ...
              <p className="text-sm text-cyan-500 text-center">Promote your medicine shop with MediMart</p>
            </div>
            <form
