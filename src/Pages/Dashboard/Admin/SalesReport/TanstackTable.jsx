  ...
  return (
    <div className="p-4 min-h-screen bg-gradient-to-br from-blue-50 via-green-50 to-white">
      <div className="max-w-6xl mx-auto">
        <h2 className="text-3xl font-extrabold mb-6 text-green-700 flex flex-col sm:flex-row items-center gap-2">
          <svg
        ...
        <div className="mb-6 flex flex-col gap-4 sm:flex-row sm:gap-6 sm:items-end bg-white/80 rounded-xl shadow p-4 border border-blue-100">
          ...
          <div className="flex gap-2">
            ...
            <button
              ...
              className="bg-green-500 hover:bg-green-600 text-white px-4 py-2 rounded-lg shadow transition flex items-center gap-2"
              ...
              {table.getRowModel().rows.map((row) => {
                ...
                return (
                  ...
                  >
                    ...
                    {r._isFirstOrderRow && (
                      <td
                        className="p-3 font-medium text-green-900 bg-green-50/50 border-r border-green-100"
                        rowSpan={r._orderRowSpan}
                      >
                        {r.buyer}
                      </td>
                    ...
                    {r._isFirstOrderRow && (
                      <td
                        className="p-3 font-semibold text-right text-green-800 bg-green-50/50 border-l border-green-100"
                        rowSpan={r._orderRowSpan}
                      >
