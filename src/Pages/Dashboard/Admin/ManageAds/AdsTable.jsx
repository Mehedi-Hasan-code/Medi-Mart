          ...
          {ads.map((ad, index) => (
            <tr key={ad.id || index} className="hover:bg-blue-50 transition-colors">
              ...
              <td className="px-4 py-3 capitalize">
                <span className={`inline-block px-3 py-1 rounded-full text-xs font-medium ${ad.status === 'active' ? 'bg-green-100 text-green-700' : 'bg-gray-200 text-gray-600'}`}>{ad.status}</span>
              </td>
              <td className="px-4 py-3">
