...
const AdminDashboard = () => {
  ...
  return (
    <div className="p-6 md:p-10">
      <h2 className="mb-8 text-2xl md:text-3xl font-bold text-gray-800">Admin Dashboard</h2>
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mt-4">
        <div className="bg-white rounded-xl shadow-md flex flex-col items-center justify-center p-6">
          ...
          <p className="text-3xl font-bold text-blue-600">${dashboard?.totalAmount?.toLocaleString(undefined, { minimumFractionDigits: 2 }) || '0.00'}</p>
        </div>
        <div className="bg-white rounded-xl shadow-md flex flex-col items-center justify-center p-6">
        ...
        <div className="bg-white rounded-xl shadow-md flex flex-col items-center justify-center p-6">
          <h3 className="text-lg font-semibold text-gray-600 mb-2">Total Paid</h3>
          <p className="text-3xl font-bold text-blue-600">${dashboard?.totalPaid?.toLocaleString(undefined, { minimumFractionDigits: 2 }) || '0.00'}</p>
        </div>
        <div className="bg-white rounded-xl shadow-md flex flex-col items-center justify-center p-6">
          <h3 className="text-lg font-semibold text-gray-600 mb-2">Total Pending</h3>
          <p className="text-3xl font-bold text-blue-600">${dashboard?.totalPending?.toLocaleString(undefined, { minimumFractionDigits: 2 }) || '0.00'}</p>
        </div>
      </div>
    </div>
  );
