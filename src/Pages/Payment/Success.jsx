...
const Success = () => {
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-blue-50 to-indigo-50 flex items-center justify-center p-4">
        <Helmet key={location.pathname}>
          <title>Medi Mart | Processing Payment</title>
        </Helmet>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-blue-50 to-indigo-50">
      <Helmet key={location.pathname}>
        <title>Payment Successful | Medi Mart</title>
      </Helmet>
                      ...
                      >
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <p className="text-xs text-gray-500">
                            Sold by{' '}
                            {item.price.product.metadata?.seller || 'MediMart'}
                          </p>
                          <p className="text-xs text-gray-500">
                            Qty: {item.quantity} × $
                  ...
                  <div className="space-y-3">
                    <div className="flex justify-between text-sm">
                      ...
                      <span className="font-medium">
                        ${(orderData.amount_subtotal / 100).toFixed(2)}
                      </span>
                    </div>
                    <div className="flex justify-between text-sm">
