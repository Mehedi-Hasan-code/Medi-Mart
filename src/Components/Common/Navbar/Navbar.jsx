...
const Navbar = () => {
  ...
  return (
    <nav className="backdrop-blur-md bg-white/70 shadow-lg rounded-xl w-full mt-4 mb-6 px-2 lg:px-8 py-2 flex items-center justify-between sticky top-4 z-50 border border-gray-200">
